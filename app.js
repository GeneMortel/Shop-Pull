...
function filter() {
    ...
    if (userInput != "" && userInput != undefined && userInput != " " && userInput != null) {
        ...
        if (flag != true) {
            ...
            document.getElementById("topButton").style.display = 'none';
            document.getElementById("display").innerText = "NO RESULTS FOUND!";
            document.getElementById("homeButton").style.display = 'block';
        }
    }
}
            ...
            if (name === key2) {
                swal({
                    ...
                    text: "Category : " + "( " + products[key][key2].category + " )  "
                        ...
                        + " --- Price : ( Php " + products[key][key2].price + " ) ",
                    textColor: "red",
                    imageUrl: src,
                    imageWidth: 300,
                    imageHeight: 250,
                ...
                for (var key2 in products[key]) {
                    if (nameProduct === key2) {
                        ...
                        swal({
                            type: "success",
                            title: "SOLD!",
                            text: "Product " + products[key][key2].name + " has been Sold. Total Price : " + quantity + "X" + products[key][key2].price + "= Php" + quantity * products[key][key2].price + "." + "THANKS!",
                        })
                        var soldd = {
                            date: DATE,
                            name: NAME,
...
function insertData(id) {
    ...
    if (id === "footwears") {
        ...
        var priceText = document.createTextNode("Php" + price);
...
function soldList() {
    ...
    for (var i = 0; i < b.length; i++) {
        ...
        var tpTdText = document.createTextNode("Php" + TP);
    ...
    document.getElementById("saleTotal").innerHTML = "Php" + tp;
}
soldList()
